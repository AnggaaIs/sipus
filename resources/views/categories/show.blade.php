<x-layouts.guest :title="$category->name . ' - Kategori Buku - SIPUS'"
    :description="$category->description ?: 'Lihat daftar buku pada kategori ' . $category->name . ' di perpustakaan SIPUS.'">
    {{-- Header --}}
        ...
        <div class="mx-auto max-w-7xl space-y-4">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl"
                    ...
                    <x-ui.icon name="tag" class="h-6 w-6"
